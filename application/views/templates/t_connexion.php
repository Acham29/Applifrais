...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
	...
	<body>
		<div id="page">
			...
			<div id="pied">
				<table id="codevalide">
					<tr><img src="<?php echo $v_path.'/templates/images/css3valide.png'?>" id="logocssvalide" /></tr>
					<tr><img src="<?php echo $v_path.'/templates/images/html5valide.png'?>" id="logohtmlvalide" /></tr>
				</table>
			</div>
